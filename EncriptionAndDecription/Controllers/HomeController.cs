...
using EncriptionAndDecription.Models;
using System.Security.Cryptography;
using System.Text;

namespace EncriptionAndDecription.Controllers
{
    public class HomeController : Controller
    {
        public IActionResult Index()
        {
            ...
            var encryptedText2 = CryptoGraphyExample.EncryptPlainTextToCipherText(encryptedText);
            var decryptedText2 = CryptoGraphyExample.DecryptCipherTextToPlainText(encryptedText2);
            var decryptedText = CryptoGraphyExample.DecryptCipherTextToPlainText(decryptedText2);

            ViewBag.text = text;
            ViewBag.Etext = encryptedText + " second :: " + encryptedText2;
            ViewBag.Dtext = decryptedText + " second :: " + decryptedText2; ;
            return View();
        }
